...
public  class ImgurUploadTask extends AsyncTask<Void, Void, String> {
        ...
        public ImgurUploadTask(Uri imageUri, Service service) {
        ...
        protected String doInBackground(Void... params) {
        	Log.d("Imgur", "doInBack");
                InputStream imageIn;
                try {
                        imageIn = mService.getContentResolver().openInputStream(mImageUri);
        ...
        InputStream responseIn = null;
            ...
            conn.setRequestProperty("Authorization", "Client-ID 8e5c21de8bdedea");
    ...
    private static int copy(InputStream input, OutputStream output) throws IOException {
        ...
        image = root.getJSONObject("data").getString("link");
        Log.d("Path", image);
		return image;
        }
        ...
        protected void onPostExecute(String s) {
    		...
    		Intent intent = new Intent(mService, ActuallyNotifyService.class);
